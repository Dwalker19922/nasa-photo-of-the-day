...
- [d ] Once you have made the call correctly, and logged the data, add the data to the state property you built.
...
- [d ] Use the effect hook to fetch the APOD data when the component mounts.
- [ d] Display the APOD data in different components that are composed together to build your UI.
